#ifndef DF_SETACTION_IP_HH
#define DF_SETACTION_IP_HH
...
class DF_SetAction : public Element {
public:
    DF_SetAction() CLICK_COLD;
    ~DF_SetAction() CLICK_COLD;

    const char *class_name() const	{ return "DF_SetAction"; }
